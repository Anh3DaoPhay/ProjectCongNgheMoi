...
// Dialog nạp tiền từ VNPay / MoMo / Chuyển khoản.
...
const _kPaymentMethods = [
  _PayMethod('VNPay', Icons.payment_rounded, Color(0xFF005BAA)),
  _PayMethod('MoMo', Icons.wallet_rounded, Color(0xFFAE2070)),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx);
              // TODO: tích hợp VNPay/MoMo WebView
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('Đang mở $method… (tính năng đang phát triển)'),
